...
const BanksSelectionP = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.banksSelectionP}>
      <View style={styles.banksSelectionPChild} />
      <View style={[styles.banksSelectionPItem, styles.fbnLogo1Position]} />
      ...
      <View style={[styles.searchBar, styles.searchBarPosition]}>
        <View style={styles.mingcutesearch2LineParent}>
          ...
          />
          <Text style={[styles.searchQueue, styles.homeTypo]}>
            Search queue
          </Text>
        </View>
        <Image
      ...
      <View style={[styles.banksSelectionPInner, styles.nedBankLogo1Position]}>
        ...
        <View style={[styles.frameParent, styles.frameLayout]}>
          ...
          >
            ...
            <Image
              ...
              contentFit="cover"
              source={require("../assets/ned-bank-logo-11.png")}
            />
          </View>
...
export default BanksSelectionP;
